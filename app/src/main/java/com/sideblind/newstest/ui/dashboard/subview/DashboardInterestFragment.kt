...
class DashboardInterestFragment : Fragment() {

    private lateinit var binding:FragmentDashboardInterestBinding
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentDashboardInterestBinding.inflate(inflater, container, false);
        return binding.root
    }
